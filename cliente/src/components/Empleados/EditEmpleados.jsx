...
const EditEmpleados = ({ isOpen, onClose, onSave, employee }) => {
    ...
    useEffect(() => {
        if (employee) {
            setFormData({
                ...initialFormState,
                ...employee,
                // Ensure date values are formatted correctly for input type="date" (YYYY-MM-DD)
                dob: employee.dob ? new Date(employee.dob).toISOString().split('T')[0] : '',
                joinDate: employee.joinDate ? new Date(employee.joinDate).toISOString().split('T')[0] : '',
                // Passwords might not be sent from backend or might be empty
    ...
    const handleSubmit = (e) => {
        ...
        // Password match validation (only if password is not empty)
        ...
        // Format updated employee object
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto animate-fade-in">
            ...
            <div className="relative bg-white w-full max-w-4xl rounded-3xl shadow-2xl border border-slate-100 flex flex-col my-8 animate-slide-down">
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-150">
                    <div>
                        <h2 className="text-xl font-black text-slate-800 tracking-tight">Editar Empleado</h2>
                        <p className="text-xs text-slate-400 mt-1">Actualiza los campos para modificar la información del integrante.</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:bg-white focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 transition-all text-sm"
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:bg-white focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 transition-all text-sm cursor-pointer"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:bg-white focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 transition-all text-sm cursor-pointer font-semibold"
                                >
                ...
                <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-150 bg-slate-50 rounded-b-3xl">
                    ...
                    <button
                        ...
                        type="submit"
                        className="flex items-center gap-2 px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-sm font-bold shadow-md shadow-amber-500/15 hover:shadow-amber-500/25 active:scale-[0.98] transition-all cursor-pointer"
                    >
                        <Save size={16} />
